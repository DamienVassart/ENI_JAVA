...
public class ServletManipulationSession extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		HttpSession session = request.getSession(); // On récupère la session éventuellement en cours ou on crée une nouvelle session si aucune n'existe
		int compteurAccesPendantSession = 0; // nombre de fois où l'on accèdera à cette servlet pendant la session
